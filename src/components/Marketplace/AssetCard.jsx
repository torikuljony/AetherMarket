...
export default function AssetCard({ asset }) {
  return (
    <Link href={`/prompt/${asset.id}`}>
      <div className="bg-[#11192d] border border-[#2a2f46] rounded-2xl overflow-hidden hover:scale-[1.02] transition duration-300 cursor-pointer">
