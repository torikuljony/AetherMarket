      ...
      <div className="mt-10 w-full max-w-3xl relative">
        <div className="group relative">
          <div className="flex items-center w-full h-14 md:h-16 rounded-3xl border border-[#2d3148] bg-[#0c1020]/90 backdrop-blur-2xl px-6 shadow-2xl shadow-black/50 transition-all duration-300 focus-within:border-[#7b61ff] focus-within:ring-2 focus-within:ring-[#7b61ff]/30 hover:border-[#7b61ff]/70">
            ...
            <button className="ml-3 px-8 py-2.5 rounded-2xl bg-gradient-to-r from-[#7b61ff] to-[#a78bff] text-white font-semibold hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg shadow-violet-500/30 flex items-center gap-2">
              Search
